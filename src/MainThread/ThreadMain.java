...
public class ThreadMain {
    ...
    public static List<Item> getPizzaItems() {
        ...
        items.add(new VeggiePizza());
        return items;
    }

    public static List<Customer> getCustomers() {
        List<Customer> customers = new ArrayList<>();
        customers.add(new Customer("rithika"));
        customers.add(new Customer("sruthi"));
        customers.add(new Customer("priya"));
        customers.add(new Customer("dhoni"));
        customers.add(new Customer("ajay"));
